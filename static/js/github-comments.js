...
function DoGithubComments(test, comment_id, page_id)
{
     var repo_name = test;
    ...
    $(document).ready(function ()
    {
        ...
        $.ajax(api_comments_url, {
            ...
            success: function(comments, textStatus, jqXHR) {
                ...
                if (page_id == 1)
                    $("#gh-comments-list").append("<a href='" + url + "#new_comment_field' rel='nofollow'>Post a comment on Github</a>");
                ...
                if ("next" in links)
                {
                    $("#gh-load-comments").attr("onclick", "DoGithubComments("  + repo_name + "," + comment_id + "," + (page_id + 1) + ");");
